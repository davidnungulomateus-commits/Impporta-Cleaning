...
export default function BookingWidget() {
  ...
  const handleFinalizeBooking = async (e, overrideStatus = null) => {
    ...
    const { error } = await supabase.from('bookings').insert([{
      ...
      property_type: selectedService,
      room_count: selectedService === 't1' ? 1 : selectedService === 't2' ? 2 : selectedService === 't3' ? 3 : 0,
      window_count: selectedService === 't1' ? 8 : selectedService === 't2' ? 12 : selectedService === 't3' ? 16 : 0,
