                  ...
                  <div className="step-actions" style={{ marginTop: '32px', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '16px' }}>
                    ...
                    {showAuthBlock && !user && (
                      <div style={{ marginTop: '8px', padding: '16px', backgroundColor: 'var(--surface)', borderRadius: '8px', border: '1px solid var(--border-color)', textAlign: 'center', width: '100%' }} className="fade-up visible">
                        <p style={{ marginBottom: '16px', fontWeight: '600' }}>Inicie sessão para um processo mais rápido ou continue como convidado:</p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center' }}>
                          <button 
                            type="button" 
                            className="btn btn-outline" 
                            onClick={handleGoogleLogin}
                            style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', width: '100%', maxWidth: '300px', justifyContent: 'center' }}
                          >
                          ...
                          <button 
                            type="button" 
                            style={{ background: 'transparent', color: 'var(--text-muted)', textDecoration: 'underline', border: 'none', padding: '8px', cursor: 'pointer', fontSize: '0.95rem' }}
                            onClick={() => setStep(2)}
                          >
